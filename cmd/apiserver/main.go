...
import (
	...
	"demo.com/ext-apiserver/pkg/apis"
	"demo.com/ext-apiserver/pkg/openapi"
	_ "demo.com/ext-apiserver/plugin/admission/install"
)
...
func main() {
	...
	err := server.StartApiServerWithOptions(&server.StartOptions{
		EtcdPath:         "/registry/demo.com/ext-apiserver",
